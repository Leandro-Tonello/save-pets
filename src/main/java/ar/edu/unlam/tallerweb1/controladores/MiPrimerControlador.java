...
import ar.edu.unlam.tallerweb1.servicios.MapaServiceImpl;
...
public class MiPrimerControlador
{
    ...
    @RequestMapping(path="/trymap", method = RequestMethod.GET)
    public ModelAndView probarMapa() throws InterruptedException, ApiException, IOException {
        String json = mapaService.ProbandoApi();
        ModelMap modelo = new ModelMap();
        modelo.put("json",json);
        return new ModelAndView("vistamap", modelo);
    }
