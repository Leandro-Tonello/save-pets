...
<h4 id="titulo"	>REGISTRAR MASCOTA</h4>
    <form:form class="col s12" action="registrar-mascota" method="POST" modelAttribute="datosMascota">
            <div id="formulario_fila" class="row">
                <div class="col">
                    <form:input class="form-control me-2" placeholder="Direccion" path="direccion" type="text" name="direccion" required="true"/>
                </div>
            </div>
            <div id="formulario_fila" class="row">
                <div class="col">
                    <form:input class="form-control me-2" placeholder="Especie" path="especie" name="especie" required="true"/>
                </div>
            </div>
